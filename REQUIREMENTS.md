...
- relying-party verification depends on ServerSentinel owning its browser origin; the dashboard is served from an origin reserved for it, with no other application sharing it;
