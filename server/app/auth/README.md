...
- Relies on the dashboard owning its browser origin (ADR-0003) for relying-party checks, and treats revocation as credential-scoped rather than device-scoped.
