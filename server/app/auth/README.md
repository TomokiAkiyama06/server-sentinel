...
- Relies on the dashboard owning its browser origin, with no other application sharing it (AUTH-011), for relying-party checks, and treats revocation as credential-scoped rather than device-scoped.
