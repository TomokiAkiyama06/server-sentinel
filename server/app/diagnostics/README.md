...
releasing that slot after caller cancellation, it shields and drains the active
worker so no second export can overlap its files or storage reservation. Before
