...
- ADR 0003 refines this for the shared-Tailscale-account deployment: the Tailscale login is not the application principal, and a per-person ServerSentinel credential is verified on every human route;
